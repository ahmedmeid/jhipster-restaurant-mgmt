...
/**
 * REST controller for managing {@link com.ahmedmeid.rstrntgmgt.domain.OrderItem}.
 */
@RestController
    ...
    public ResponseEntity<OrderItem> partialUpdateOrderItem(
        ...
        Optional<OrderItem> result = orderItemRepository
            ...
            .map(existingOrderItem -> {
                ...
                if (orderItem.getSpecialRequests() != null) {
                    existingOrderItem.setSpecialRequests(orderItem.getSpecialRequests());
                }
