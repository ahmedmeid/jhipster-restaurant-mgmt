...
/**
 * REST controller for managing {@link com.ahmedmeid.rstrntgmgt.domain.MenuItem}.
 */
@RestController
...
public class MenuItemResource {
        ...
        Optional<MenuItem> result = menuItemRepository
            ...
            .map(existingMenuItem -> {
                ...
                if (menuItem.getItemDescription() != null) {
                    existingMenuItem.setItemDescription(menuItem.getItemDescription());
                }
    ...
    public List<MenuItem> getAllMenuItems(
        ...
        if (eagerload) {
            return menuItemRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<MenuItem> getMenuItem(@PathVariable("id") Long id) {
        ...
        Optional<MenuItem> menuItem = menuItemRepository.findOneWithEagerRelationships(id);
