...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DINEINORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DINEINORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DINEINORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DINEINORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DINEINORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DINEINORDER actions', async () => {
      const arg = 42666;
