...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTAURANTMENU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESTAURANTMENU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESTAURANTMENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESTAURANTMENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESTAURANTMENU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESTAURANTMENU actions', async () => {
      const arg = 42666;
