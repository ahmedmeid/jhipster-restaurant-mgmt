...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENUCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENUCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENUCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MENUCATEGORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MENUCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENUCATEGORY actions', async () => {
      const arg = 42666;
