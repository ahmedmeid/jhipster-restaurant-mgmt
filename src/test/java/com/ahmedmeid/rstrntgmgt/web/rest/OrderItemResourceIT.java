...
import static com.ahmedmeid.rstrntgmgt.domain.OrderItemAsserts.*;
...
import com.ahmedmeid.rstrntgmgt.domain.OrderItem;
import com.ahmedmeid.rstrntgmgt.repository.OrderItemRepository;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().quantity(DEFAULT_QUANTITY).specialRequests(DEFAULT_SPECIAL_REQUESTS);
        return orderItem;
    }
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        OrderItem orderItem = new OrderItem().quantity(UPDATED_QUANTITY).specialRequests(UPDATED_SPECIAL_REQUESTS);
        return orderItem;
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.quantity(UPDATED_QUANTITY).specialRequests(UPDATED_SPECIAL_REQUESTS);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).specialRequests(UPDATED_SPECIAL_REQUESTS);
