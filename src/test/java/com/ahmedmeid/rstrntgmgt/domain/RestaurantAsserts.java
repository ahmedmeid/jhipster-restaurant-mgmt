...
public class RestaurantAsserts {
    ...
    public static void assertRestaurantUpdatableFieldsEquals(Restaurant expected, Restaurant actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getRestaurantName()).as("check restaurantName").isEqualTo(actual.getRestaurantName()))
            .satisfies(
                e -> assertThat(e.getRestaurantDescription()).as("check restaurantDescription").isEqualTo(actual.getRestaurantDescription())
            )
            .satisfies(e -> assertThat(e.getNoOfTables()).as("check noOfTables").isEqualTo(actual.getNoOfTables()));
    }
